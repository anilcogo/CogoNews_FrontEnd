...
const Card =({source,title,id,content,description})=>{
    ...
    <div>
    <Link href={`blogview/${id}`}><a className="inner-link" style={{"color":"black", "backgroundColor":"#F67280","border":"2px solid lightgray", "margin":"5px","border-radius": "30px"}}>Delete</a></Link>
